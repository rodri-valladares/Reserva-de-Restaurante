...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    var arrayRestaurantes=this.restaurantes;
    

    var restauranteEncontrado=arrayRestaurantes.find(function(restaurantex){return restaurantex.id === id;});
...
function filtraRepetidos(arrayAFiltrar){
    var arrayFiltrado= arrayAFiltrar.filter(function(elem, index, self) {
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    arrayrestaurantes=this.restaurantes;
    arrayCiudades= arrayrestaurantes.map(function(restaurante){ return restaurante.ubicacion});

    //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
    var ciudadesFiltradas = filtraRepetidos(arrayCiudades);
...
Listado.prototype.obtenerRubros = function() {
    ...
    arrayrestaurantes=this.restaurantes;
    arrayRubros= arrayrestaurantes.map(function(restaurante){ return restaurante.rubro});

    var rubrosFiltrados = filtraRepetidos(arrayRubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    arrayrestaurantes=this.restaurantes;
    arrayDeHorarios= arrayrestaurantes.map(function(restaurante){ return restaurante.horarios});
    ...
    var horariosFiltrados = filtraRepetidos(arrayHoras);
